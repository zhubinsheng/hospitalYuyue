...
public class ScoreController {
    ...
    public ResultObject<List<youhui>> getAllSumScore(TStudent student, @RequestParam("limit") int limit, @RequestParam("page") int page) {
    	PageInfo<youhui> pageInfo =scoreService.getAllFinalScore(student, limit, page);
    	ResultObject<List<youhui>> rs=new ResultObject<List<youhui>>();
    	rs.setCode(Constant.SUCCESS_RETUEN_CODE);
    	rs.setMsg("查询成功");
