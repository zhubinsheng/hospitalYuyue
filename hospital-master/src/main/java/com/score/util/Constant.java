...
public class Constant {
	public static String getAllScore="/score/getAllScore";
	...
	public static String LOGON_URI="/user/studentLogon";
	//学生登录请求地址
	...
	public static String HUI_SHI_URL="/HuiShi/selectAll";
	public static String HOSIPTAL_URL="/HuiShi/selectHos";
	public static String KESHI_URL="/HuiShi/selectKe";
	public static String record="/HuiShi/record";
	public static String selectrecord="/HuiShi/selectrecord";
}
